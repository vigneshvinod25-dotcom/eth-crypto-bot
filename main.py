...
def start_bot():
    ...
    # Testnet Exchange (For Placing Orders)
    ...
    # Real Binance Exchange (For Real Market Data)
    ...
    while True:
        try:
            # Fetching Real Market Chart Data
            bars = real_exchange.fetch_ohlcv(symbol, timeframe=timeframe, limit=50)
            ...
            print(f"Checking Real {symbol}... Prev EMA9: {prev_ema9:.2f}, Prev EMA21: {prev_ema21:.2f} | Curr EMA9: {curr_ema9:.2f}, Curr EMA21: {curr_ema21:.2f}")
...
@app.route('/')
def home():
    return "Bot is running 24/7 on Real Data + Binance Testnet!"
